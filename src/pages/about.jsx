...
const About = () => {
  return (
    <div id="about" className="h-200 mt-20">
      <motion.div className="text-white  text-center flex-row justify-between item-center"
        ...
        <p className="text-lg mb-20">Hello! My Name is Anurag Singh. I am a Passionate Full Stack Developer || Machine Learning & Artifical Intelligence Enthusiast || Problem Solver  </p>
      </motion.div>
      <motion.div className="text-white  text-center flex-row justify-between item-center"
        initial = {{opacity: 0, y: 40}}
        whileInView = {{opacity: 1, y: 0}}>
        <h2 className="text-4xl font-bold m-5">Who I Am ?</h2>
        <p className="text-lg mx-55">Currently I am a collage student persuing BTech in Computer Science And Engeineering with Speicialization in Artificial Intelligence from GL BAJAJ INSTITUTE OF TECHNOLOGY AND MANGEMENT GREATER NOIDA </p>
      </motion.div>
      <motion.div className="text-white mt-20 text-center flex-row justify-between item-center"
        ...
        <p className="text-lg mx-40"> Full Stack Developement || Frontend - ReactJS , Tailwind CSS || Backend - ExpressJS , MongoDB || Problem Solving - LeetCode & Codechef || Engineering  <br /> || Programming Languages - JavaScript, Python, Java, C , C++ ||</p>
      </motion.div>
       ...
       <motion.div className="text-white m-15 text-center flex-row justify-between item-center"
        initial = {{opacity: 0, y: 40}}
        whileInView = {{opacity: 1, y: 0}}>
        <h2 className="text-4xl font-bold m-5">What I am Doing ?</h2>
        <p className="text-lg mx-55">Currently I am focussing on Diving more deep in full stack developement and keep grinding leetcode and problem solving and learning fundamentals of Machine learning to go in depth further </p>
      </motion.div>
    </div>
  )
}
