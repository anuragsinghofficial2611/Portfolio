...
const Home = () => {
    return (
        <div className="h-screen">
            <Navbar />
            <div>
                <motion.p className="text-blue-400 mx-10 font-bold"
            ...
            <motion.div
                ...
                delay={0.2}
                className="mx-10">
                <p className="text-white text-8xl font-extrabold text-left ">
                    TURNING COFFEE INTO <span className="text-blue-700">CODE</span>,<br />
                    IDEAS INTO <span className="text-blue-700">PRODUCTS</span>,<br />
                    AND PROBLEMS INTO <span className="text-blue-700 text-9xl tracking-widest">SOLUTIONS</span>
                </p>
            </motion.div>
